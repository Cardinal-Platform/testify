...
func TestGreater(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.helpers, "github.com/Cardinal-Platform/testify/assert.Greater")
	}
}
...
func TestGreaterOrEqual(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, string(out.buf.Bytes()), currCase.msg)
		Contains(t, out.helpers, "github.com/Cardinal-Platform/testify/assert.GreaterOrEqual")
	}
}
...
func TestLess(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, string(out.buf.Bytes()), currCase.msg)
		Contains(t, out.helpers, "github.com/Cardinal-Platform/testify/assert.Less")
	}
}
...
func TestLessOrEqual(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, string(out.buf.Bytes()), currCase.msg)
		Contains(t, out.helpers, "github.com/Cardinal-Platform/testify/assert.LessOrEqual")
	}
}
...
func TestPositive(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, string(out.buf.Bytes()), currCase.msg)
		Contains(t, out.helpers, "github.com/Cardinal-Platform/testify/assert.Positive")
	}
}
...
func TestNegative(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, string(out.buf.Bytes()), currCase.msg)
		Contains(t, out.helpers, "github.com/Cardinal-Platform/testify/assert.Negative")
	}
}
