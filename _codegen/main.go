...
var (
	pkg       = flag.String("assert-path", "github.com/Cardinal-Platform/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/Cardinal-Platform/testify/_codegen
